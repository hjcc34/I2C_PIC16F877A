...
void READ_DS1307 (void)
{
    ...
    lectura_tiempo_posY(0x04,12,11,10,'-');
    lectura_tiempo_posY(0x05,9,8,7,'-');
    lectura_tiempo_posY(0x06,6,5,4,'0');
    Lcd_pos_y(3);
    Lcd_Write_Char('2');
}
...
void AJUSTE_DS1307(void)
{
    ...
    {
        Lcd_print_string(1,"1.Ajuste Fecha",1,"2.Ajuste de Hora");
        ...
        if (PORTBbits.RB2 == 0)
        {
            ...
            while (PORTBbits.RB3 == 1)
            {
                Lcd_print_string(1,"1.Dia     3.Ano",1,"2.Mes");
                ...
                if (PORTBbits.RB2 == 0)
                {
                    ...
                    while (PORTBbits.RB3 == 1)
                    {
                        Lcd_print_string(2,"Ajuste de dia",1,"");
                        Lcd_pos_y(9);
                        Lcd_Write_Char(dato_ajuste_dia_lcd_unidad);
                        Lcd_pos_y(8);
                        Lcd_Write_Char(dato_ajuste_dia_lcd_decena);
                        if (PORTBbits.RB2 == 0)
                        {
                        ...
                        {
                            _delay((unsigned long)((1000)*(4000000/4000.0)));
                            I2C_Cmd(0xD0,0x04,dato_ajuste_dia);
                            I2C_P();
                            Lcd_cmd(1);
                            break;
                        }
                ...
                if (PORTBbits.RB1 == 0)
                {
                    ...
                    while (PORTBbits.RB3 == 1)
                    {
                        Lcd_print_string(2,"Ajuste de Mes",1,"");
                        if (PORTBbits.RB3 == 0)
                        {
                            break;
                        }
                ...
                if (PORTBbits.RB4 == 0)
                {
                    ...
                    while (PORTBbits.RB3 == 1)
                    {
                        Lcd_print_string(2,"Ajuste de Ano",1,"");
                        if (PORTBbits.RB3 == 0)
                        {
                            break;
                        }
